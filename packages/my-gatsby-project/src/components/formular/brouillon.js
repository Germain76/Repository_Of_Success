...
import * as qs from "query-string"export const ContactForm = ({location, success, error, submit, formFields, children}) => {
  ...
  const [ processing, setProcessing] = React.useState(false);  const handleChangeField = (name) => (evt) => {
